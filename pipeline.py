...
def safe_project_name(zip_path: str) -> str:
    ...
    with zipfile.ZipFile(
        ...
        for member in archive.infolist():
            ...
            if (
                ...
                and extraction_root not in target.parents
            ):
                raise ValueError(
...
def run_pipeline(
    ...
    """
    Run the complete TDD generation pipeline.
    ...
    This function is used by Flask/Render and can also
    ...
    if project_path.is_file():
        ...
        # For a single uploaded source file, scan its
        ...
        raise ValueError(
            f"Unsupported project path: {project_path}"
        )
